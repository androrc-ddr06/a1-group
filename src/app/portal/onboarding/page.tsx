...
export default function OnboardingPage() {
  ...
  async function handleSubmit() {
    setSubmitting(true);
    // Wire to Supabase save + Resend notification later
      ...
      <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-5">
              ...
              <Field label="Company Name" required>
                <input
                  ...
                  placeholder="Roosters Rolling Barbecue"
              ...
              <Field label="Industry">
                <input
                  ...
                  placeholder="Food & Beverage, Retail, Services..."
                  className={inputClass}
                />
              </Field>
            ...
            <div className="space-y-5">
              ...
              <Field label="Brand Colors (hex codes or describe them)">
                <input
                  ...
                  placeholder="#FF5733, Navy Blue, White..."
                  className={inputClass}
                />
              </Field>
              ...
              <Field label="Font Preferences (if any)">
                <input
                  ...
                  placeholder="Modern, bold, serif... or 'we have no preference'"
                  className={inputClass}
                />
              </Field>
            </div>
            ...
            <div className="space-y-5">
              ...
              <Field label="Any Other Platforms">
                <input
                  ...
                  placeholder="YouTube, LinkedIn, Twitter/X..."
                  className={inputClass}
                />
              </Field>
            </div>
            ...
            <div className="space-y-5">
              ...
              <Field label="Who is your target audience?" required>
                <textarea
                  ...
                  placeholder="Age range, location, interests, income level..."
                  className={`${inputClass} resize-none`}
                />
              </Field>
              ...
              <Field label="Who are your top 2–3 competitors?">
                <input
                  ...
                  placeholder="Business names or Instagram handles"
                  className={inputClass}
                />
              </Field>
            </div>
          ...
          {step === 5 && (
            <div className="space-y-6">
              ...
              <div className="bg-[#c9a84c]/10 border border-[#c9a84c]/20 rounded-xl p-4 text-sm text-[#c9a84c]">
                After submitting, Alejandro will review your information and
                reach out within 24 hours to schedule your kickoff call.
              </div>
            </div>
          )}
        </div>
        ...
        <div className="flex items-center justify-between mt-6">
          <button
            onClick={back}
            disabled={step === 1}
            className="flex items-center gap-2 text-white/40 hover:text-white disabled:opacity-20 disabled:cursor-not-allowed font-medium text-sm transition-colors"
          >
          ...
          {step < TOTAL_STEPS ? (
            <button
              onClick={next}
              className="flex items-center gap-2 bg-[#c9a84c] hover:bg-[#d4af61] text-[#0a1628] font-bold text-sm px-6 py-3 rounded-full transition-all"
            >
            ...
            <button
              ...
              disabled={submitting}
              className="flex items-center gap-2 bg-[#c9a84c] hover:bg-[#d4af61] disabled:opacity-60 text-[#0a1628] font-bold text-sm px-6 py-3 rounded-full transition-all"
            >
...
const inputClass =
  "w-full bg-white/5 border border-white/15 rounded-xl px-4 py-3 text-white placeholder:text-white/25 text-sm focus:outline-none focus:border-[#c9a84c]/60 transition-all";
